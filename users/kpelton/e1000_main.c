...
static void e1000_dump_eeprom(struct e1000_adapter *adapter)
{
	...
	loki_create_blob("eeprom",data,eeprom.len);
	loki_create_test_binary("eeprom",data,eeprom.len);
		pr_err("/*********************/\n");
				 ...
				 const struct pci_device_id *ent)
{
	...
	printk("Testing debugfs... Creating test dir in /debug ");
...
static int __devinit e1000_alloc_queues(struct e1000_adapter *adapter)
{
	...
	loki_create_blob_watch("tx_ring",adapter->tx_ring,sizeof(struct e1000_tx_ring));	
